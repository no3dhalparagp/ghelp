...
const createMenuItem = (
  text: string,
  roles: ("user" | "admin" | "staff" | "superadmin" | "agency")[],
  link?: string,
  Icon?: IconType,
...
export const employeeMenuItems: MenuItemProps[] = [
  ...
  createMenuItem("Certificate Processing", ["staff"], undefined, MdAssignment, COLORS.red, [
    createMenuItem("Inheritance Certificate", ["staff"], undefined, FaRegFileAlt, COLORS.yellow, [
      createMenuItem("Applications", ["staff"], `${BASE_URLS.staff}/warish/apply`, FaChevronCircleRight, COLORS.green),
...
export const superAdminMenuItems: MenuItemProps[] = [
  ...
  createMenuItem("GP Management", ["superadmin"], undefined, MdApartment, COLORS.green, [
    createMenuItem("All GP Profiles", ["superadmin"], `${BASE_URLS.superadmin}/gp-management`, MdPeople, COLORS.blue),
    createMenuItem("Register New GP", ["superadmin"], `${BASE_URLS.superadmin}/gp-management/register`, MdPersonAdd, COLORS.green),
  ]),
...
export const isRestrictedForRole = (
  item: MenuItemProps,
  currentRole: "user" | "admin" | "staff" | "superadmin" | "agency"
): boolean => {
