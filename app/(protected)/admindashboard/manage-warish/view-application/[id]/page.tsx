            ...
            <Card>
              <CardHeader className="pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-xl">
                    GP Profile Information
                  </CardTitle>
                </div>
                <CardDescription>
                  Details of the associated GP Profile
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <InfoItem
                    icon={<User className="h-4 w-4 text-muted-foreground" />}
                    label="GP Name"
                    value={application.gpProfile.gpname || "N/A"}
                  />
                  <InfoItem
                    icon={<Phone className="h-4 w-4 text-muted-foreground" />}
                    label="GP Phone"
                    value={application.gpProfile.gpcode || "N/A"}
                  />
                  <InfoItem
                    icon={<User className="h-4 w-4 text-muted-foreground" />}
                    label="GP Email"
                    value={application.gpProfile.gpshortname || "N/A"}
                  />
                </div>
              </CardContent>
            </Card>
