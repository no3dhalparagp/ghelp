    ...
    <div className="min-h-screen bg-wb-bg container mx-auto px-4 py-8 space-y-6 max-w-7xl">
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        <Card className="bg-white w-full max-w-3xl ml-auto border border-wb-border shadow-sm">
            ...
            {(() => {
              ...
              return (
                <>
                  ...
                  <div className="flex justify-between items-center py-1 font-bold text-lg text-wb-primary">
                    <span>Say Amount</span>
                    <span className="font-mono">₹{sayAmount.toFixed(2)}</span>
                  </div>
                  ...
                  <div className="pt-4 space-y-2">
                    ...
                    <div className="flex justify-between text-sm text-muted-foreground">
                      ...
                      <span className="font-mono">{lwcAmount.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between font-bold text-xl text-wb-primary border-t-2 border-wb-primary/20 pt-2 mt-2">
          ...
          <CardFooter className="bg-wb-primary/5 p-4 flex justify-center">
            <p className="text-xs text-muted-foreground italic">
              * Amounts are rounded to the nearest rupee where applicable
            </p>
          </CardFooter>
        </Card>
      </div>
